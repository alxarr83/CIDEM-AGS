...
/**
 * Strings for component 'tiny_media', language 'es_mx', version '4.4'.
 *
 * @package     tiny_media
 * @category    string
...
$string['addfilesdrop'] = 'Arrastrar y soltar una imagen para subirla, o clic para seleccionarla';
...
$string['browserepositoriesimage'] = 'Mirar repositorios';
...
$string['constrain'] = 'Conservar proporción';
...
$string['deleteimagewarning'] = '¿Está seguro que quiere quitar la imagen?';
...
$string['enteralt'] = '¿Cómo describiría esta imagen para alguien que no pueda verla:';
...
$string['mute'] = 'Mudo';
$string['pluginname'] = 'Insertar medio';
...
$string['repositorynotpermitted'] = 'Pegar un enlace de imagen en el campo inferior.';
$string['repositoryuploadnotpermitted'] = 'Pegar un enlace de imagen en el campo inferior, o<br>hacer clic en el botón para Mirar Repositorios.';
$string['saveimage'] = 'Guardar';
$string['size'] = 'Ancho x altura (en pixeles)';
$string['sizecustom'] = 'Tamaño personalizado';
$string['sizecustom_help'] = 'Esta imagen solamente es una vista previa. Los cambios a su tamaño serán visibles después que la guarde.';
