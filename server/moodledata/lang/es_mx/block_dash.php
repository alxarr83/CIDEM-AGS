...
$string['parentrole'] = 'Usuarios I gestionar';
$string['parentrole_help'] = 'Solamente incluye usuarios que el usuario actual les tiene un rol asignado. Vea  "<a href="https://docs.moodle.org/all/es/Rol_paterno" target="_blank">Rol paterno</a>.';
