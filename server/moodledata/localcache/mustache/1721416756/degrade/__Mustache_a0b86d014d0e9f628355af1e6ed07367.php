...
class __Mustache_a0b86d014d0e9f628355af1e6ed07367 extends Mustache_Template
{
...
';
            ...
            if (empty($value)) {
                ...
                $buffer .= $this->section0ff3737d0ba275744f4390f4abcba3b5($context, $indent, $value);
            }
            $buffer .= $indent . '
';
...
';
    ...
    private function section37540599f55db7ae158689bccdc09ab0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = 'footerblock_copywriter_text,theme_degrade';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= 'footerblock_copywriter_text,theme_degrade';
                $context->pop();
            }
        }
    ...
    private function sectionC72bb88eeb7b6be69880fab3115d16ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="footer-foot">
                                <div class="container">
                                    <p class="text-center">
                                        {{#str}}footerblock_copywriter_text,theme_degrade{{/str}}
...
';
                ...
                $buffer .= $this->section37540599f55db7ae158689bccdc09ab0($context, $indent, $value);
                $buffer .= '
';
...
';
    ...
    private function section0ff3737d0ba275744f4390f4abcba3b5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionC72bb88eeb7b6be69880fab3115d16ef($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $buffer .= $indent . '                </div>
';
